...
from django.conf import settings  # User 모델 임포트 추가
...
class Post(models.Model):  # 이 부분이 반드시 있어야 함
    ...
    author = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE)  # User 모델 사용
    pub_date = models.DateTimeField(auto_now_add=True)
    views = models.PositiveIntegerField(default=0)  # 조회수
    likes = models.ManyToManyField(settings.AUTH_USER_MODEL, related_name='liked_posts')  # 좋아요
